...
logfile="/att/nobackup/mwooten3/Paul_TTE/queryLogs/batch${batch}_ADAPT_query_log.txt"
...
date
#printf "\n"
cmd="nohup rsync -avxH --progress /att/nobackup/mwooten3/Paul_TTE/ASP/batch$batch-archive.tar.gz discover.nccs.nasa.gov:/discover/nobackup/projects/boreal_nga/ASP"
printf " $cmd\n\n"
eval $cmd
printf "\n\nEND: "
#end_date=date
